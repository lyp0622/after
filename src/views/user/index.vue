...
export default {
  ...
  computed: {
    ...mapState({
      ...
      apilength: state => state.author.apilength, //所有api接口权限数据长度
      allGuanXi: state => state.author.allGuanXi, //获取身份和api权限关系数据
      allGuanXilength: state => state.author.allGuanXilength, //身份和api权限关系数据长度
      allAuthorViews: state => state.author.allAuthorViews, //展示身份和视图权限关系的所有数据
      allAuthorViewslength: state => state.author.allAuthorViewslength, //所以身份和视图权限关系数据的长度
      allViewsQX: state => state.author.allViewsQX, //获取视图权限数据的所有数据
      allViewsQXlength: state => state.author.allViewsQXlength  //获取视图权限数据的所有数据的长度
    })
  },
  methods: {
    ...mapActions({
